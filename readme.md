...
If you're from jane street, use [this](https://deepwiki.com/astroanax/aoc2025-solutions/) to get nice cute diagrams of the state machines and all, bro. Also, only days 1, 3, 4 and 6 follow the guidelines of implementing all code in the hardware, the rtl way.
